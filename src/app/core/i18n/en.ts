...
export const en: typeof de = {
  ...
  formatRecs: {
    ...
    hint: "Pick a format - popular archetypes get checked against your collection, including what's already planned in other decks.",
    ...
    backToList: '← Back to list',
    scanningHubs: 'Searching archetypes…',
    checkingHubs: 'Checking archetypes… ({{progress}})',
    noResults: 'No matching archetypes found.',
    loadFailed: 'Recommendations could not be loaded.',
    detailFailed: 'Card list could not be loaded.',
    addDeckFailed: 'Deck could not be added.',
  },
